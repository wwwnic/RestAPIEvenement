...
-- Dumping data for table projetevenements.evenement: ~2 rows (approximately)
...
INSERT INTO `evenement` (`idEvenement`, `nomEvenement`, `location`, `date`, `idOrganisateur`, `description`) VALUES
	...
	(2, 'Evenement', 'la place des evenements', '2021-11-17 18:33:24', 1, 'tout un evenement');
...
INSERT INTO `utilisateur` (`idUtilisateur`, `nomUtilisateur`, `motDePasse`, `courriel`, `telephone`, `dateCreation`) VALUES
	(1, 'admin', 'secret', 'test', 'test', '2021-11-16');
...
INSERT INTO `utilisateurevenement` (`idEvenement`, `idUtilisateur`) VALUES
	(1, 1);
